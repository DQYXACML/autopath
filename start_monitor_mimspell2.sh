#!/bin/bash
# 自动生成的Monitor启动脚本 - MIMSpell2
#
# 使用方法:
#   ./start_monitor_mimspell2.sh
#
# 环境变量（可选）:
...
# 协议配置
PROTOCOL="mimspell2"
PROTOCOL_NAME="MIMSpell2"
DEPLOYMENT_FILE="$PROJECT_ROOT/test/MIMSpell2_exp/scripts/data/deployment.json"
TEMPLATE_FILE="config/templates/mimspell2_dynamic.json.tmpl"
CONFIG_FILE="pkg/invariants/configs/mimspell2-dynamic.json"
RULE_EXPORT_PATH="../test/MIMSpell2_exp/scripts/data/firewall-rules.json"
...
if [ ! -f "$DEPLOYMENT_FILE" ]; then
    ...
    echo ""
    echo "请先运行部署脚本："
    echo "  forge script test/MIMSpell2_exp/scripts/DeployContracts.s.sol \\"
    echo "    --tc DeployMIMSpell2Contracts \\"
