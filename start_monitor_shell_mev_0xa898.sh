#!/bin/bash
# 自动生成的Monitor启动脚本 - ShellMEV0xa898
#
# 使用方法:
#   ./start_monitor_shell_mev_0xa898.sh
#
# 环境变量（可选）:
...
# 协议配置
PROTOCOL="shell_mev_0xa898"
PROTOCOL_NAME="ShellMEV0xa898"
DEPLOYMENT_FILE="$PROJECT_ROOT/test/Shell_MEV_0xa898_exp/scripts/data/deployment.json"
TEMPLATE_FILE="config/templates/shell_mev_0xa898_dynamic.json.tmpl"
CONFIG_FILE="pkg/invariants/configs/shell_mev_0xa898-dynamic.json"
RULE_EXPORT_PATH="../test/Shell_MEV_0xa898_exp/scripts/data/firewall-rules.json"
...
if [ ! -f "$DEPLOYMENT_FILE" ]; then
    ...
    echo ""
    echo "请先运行部署脚本："
    echo "  forge script test/Shell_MEV_0xa898_exp/scripts/DeployContracts.s.sol \\"
    echo "    --tc DeployShellMEV0xa898Contracts \\"
