#!/bin/bash
# 自动生成的Monitor启动脚本 - WiseLending02
#
# 使用方法:
#   ./start_monitor_wiselending02.sh
#
# 环境变量（可选）:
...
# 协议配置
PROTOCOL="wiselending02"
PROTOCOL_NAME="WiseLending02"
DEPLOYMENT_FILE="$PROJECT_ROOT/test/WiseLending02_exp/scripts/data/deployment.json"
TEMPLATE_FILE="config/templates/wiselending02_dynamic.json.tmpl"
CONFIG_FILE="pkg/invariants/configs/wiselending02-dynamic.json"
RULE_EXPORT_PATH="../test/WiseLending02_exp/scripts/data/firewall-rules.json"
...
if [ ! -f "$DEPLOYMENT_FILE" ]; then
    ...
    echo ""
    echo "请先运行部署脚本："
    echo "  forge script test/WiseLending02_exp/scripts/DeployContracts.s.sol \\"
    echo "    --tc DeployWiseLending02Contracts \\"
