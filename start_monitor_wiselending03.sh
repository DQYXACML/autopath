#!/bin/bash
# 自动生成的Monitor启动脚本 - WiseLending03
#
# 使用方法:
#   ./start_monitor_wiselending03.sh
#
# 环境变量（可选）:
...
# 协议配置
PROTOCOL="wiselending03"
PROTOCOL_NAME="WiseLending03"
DEPLOYMENT_FILE="$PROJECT_ROOT/test/WiseLending03_exp/scripts/data/deployment.json"
TEMPLATE_FILE="config/templates/wiselending03_dynamic.json.tmpl"
CONFIG_FILE="pkg/invariants/configs/wiselending03-dynamic.json"
RULE_EXPORT_PATH="../test/WiseLending03_exp/scripts/data/firewall-rules.json"
...
if [ ! -f "$DEPLOYMENT_FILE" ]; then
    ...
    echo ""
    echo "请先运行部署脚本："
    echo "  forge script test/WiseLending03_exp/scripts/DeployContracts.s.sol \\"
    echo "    --tc DeployWiseLending03Contracts \\"
